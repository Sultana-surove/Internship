...
$layout = new TLayout("menu_bootstrap1", "CoralOffice", "MobileOffice");
$layout->version = 3;
...
$tableEvents["main"] = new eventclass_main;
include_once(getabspath("include/inv_risk_events.php"));
$tableEvents["inv-risk"] = new eventclass_inv_risk;
include_once(getabspath("include/Month_sales_events.php"));
$tableEvents["Month_sales"] = new eventclass_Month_sales;
