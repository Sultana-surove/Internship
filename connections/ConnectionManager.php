...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 3;
		$data["connId"] = "ME_accdb";
		$data["connName"] = "ME.accdb";
		$data["connStringType"] = "file";
		$data["connectionString"] = "file;D:\\\\rsoft\\\\ME.accdb;root;;Microsoft Access Driver (*.mdb, *.accdb);0;access"; //currently unused
		
		$this->_connectionsIdByName["ME.accdb"] = "ME_accdb";
		...
		$data["connInfo"][0] = "D:\\rsoft\\ME.accdb";
		$data["connInfo"][1] = "root";
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "Microsoft Access Driver (*.mdb, *.accdb)";
		$data["connInfo"][4] = "0";
		$data["connInfo"][5] = "access"; //currently unused
		$data["connInfo"][6] = ""; //currently unused
		$data["ODBCString"] = "Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=" . getabspath("db\\ME.accdb") . ";Uid=root;Pwd=";
		// encription set
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["Acc_type"] = "ME_accdb";
		$connectionsIds["asst_desc"] = "ME_accdb";
		$connectionsIds["BRI"] = "ME_accdb";
		$connectionsIds["main"] = "ME_accdb";
		$connectionsIds["FM_Income"] = "ME_accdb";
		$connectionsIds["Org_info"] = "ME_accdb";
		$connectionsIds["PFLI"] = "ME_accdb";
		$connectionsIds["Produ_Info"] = "ME_accdb";
		$connectionsIds["Remitance"] = "ME_accdb";
		$connectionsIds["St_Info"] = "ME_accdb";
		$connectionsIds["asset_des"] = "ME_accdb";
		$connectionsIds["inv-risk"] = "ME_accdb";
		$connectionsIds["R-1"] = "ME_accdb";
		$connectionsIds["Approv"] = "ME_accdb";
		$connectionsIds["Req"] = "ME_accdb";
		$connectionsIds["Month_sales"] = "ME_accdb";
		$connectionsIds["userinfo"] = "ME_accdb";
		$connectionsIds["main Report"] = "ME_accdb";
