...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("userinfo", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "Acc_type" ] = array( "url" => "Acc_type", "type" => 0 );
	$projectEntitiesReverse[ "Acc_type" ] = "Acc_type";
	$projectEntities[ "asst_desc" ] = array( "url" => "asst_desc", "type" => 0 );
	$projectEntitiesReverse[ "asst_desc" ] = "asst_desc";
	$projectEntities[ "BRI" ] = array( "url" => "BRI", "type" => 0 );
	$projectEntitiesReverse[ "BRI" ] = "BRI";
	$projectEntities[ "main" ] = array( "url" => "main", "type" => 0 );
	$projectEntitiesReverse[ "main" ] = "main";
	$projectEntities[ "FM_Income" ] = array( "url" => "FM_Income", "type" => 0 );
	$projectEntitiesReverse[ "FM_Income" ] = "FM_Income";
	$projectEntities[ "Org_info" ] = array( "url" => "Org_info", "type" => 0 );
	$projectEntitiesReverse[ "Org_info" ] = "Org_info";
	$projectEntities[ "PFLI" ] = array( "url" => "PFLI", "type" => 0 );
	$projectEntitiesReverse[ "PFLI" ] = "PFLI";
	$projectEntities[ "Produ_Info" ] = array( "url" => "Produ_Info", "type" => 0 );
	$projectEntitiesReverse[ "Produ_Info" ] = "Produ_Info";
	$projectEntities[ "Remitance" ] = array( "url" => "Remitance", "type" => 0 );
	$projectEntitiesReverse[ "Remitance" ] = "Remitance";
	$projectEntities[ "St_Info" ] = array( "url" => "St_Info", "type" => 0 );
	$projectEntitiesReverse[ "St_Info" ] = "St_Info";
	$projectEntities[ "asset_des" ] = array( "url" => "asset_des", "type" => 0 );
	$projectEntitiesReverse[ "asset_des" ] = "asset_des";
	$projectEntities[ "inv-risk" ] = array( "url" => "inv_risk", "type" => 0 );
	$projectEntitiesReverse[ "inv_risk" ] = "inv-risk";
	$projectEntities[ "R-1" ] = array( "url" => "R_1", "type" => 0 );
	$projectEntitiesReverse[ "R_1" ] = "R-1";
	$projectEntities[ "Approv" ] = array( "url" => "Approv", "type" => 0 );
	$projectEntitiesReverse[ "Approv" ] = "Approv";
	$projectEntities[ "Req" ] = array( "url" => "Req", "type" => 0 );
	$projectEntitiesReverse[ "Req" ] = "Req";
	$projectEntities[ "Month_sales" ] = array( "url" => "Month_sales", "type" => 0 );
	$projectEntitiesReverse[ "Month_sales" ] = "Month_sales";
	$projectEntities[ "userinfo" ] = array( "url" => "userinfo", "type" => 0 );
	$projectEntitiesReverse[ "userinfo" ] = "userinfo";
	$projectEntities[ "main Report" ] = array( "url" => "main_Report", "type" => 2 );
	$projectEntitiesReverse[ "main_Report" ] = "main Report";
}
