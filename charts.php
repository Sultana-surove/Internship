...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("Acc_type" == $this->chrt_array['tables'][0])
			return true;
		if("asst_desc" == $this->chrt_array['tables'][0])
			return true;
		if("BRI" == $this->chrt_array['tables'][0])
			return true;
		if("main" == $this->chrt_array['tables'][0])
			return true;
		if("FM_Income" == $this->chrt_array['tables'][0])
			return true;
		if("Org_info" == $this->chrt_array['tables'][0])
			return true;
		if("PFLI" == $this->chrt_array['tables'][0])
			return true;
		if("Produ_Info" == $this->chrt_array['tables'][0])
			return true;
		if("Remitance" == $this->chrt_array['tables'][0])
			return true;
		if("St_Info" == $this->chrt_array['tables'][0])
			return true;
		if("asset_des" == $this->chrt_array['tables'][0])
			return true;
		if("inv-risk" == $this->chrt_array['tables'][0])
			return true;
		if("R-1" == $this->chrt_array['tables'][0])
			return true;
		if("Approv" == $this->chrt_array['tables'][0])
			return true;
		if("Req" == $this->chrt_array['tables'][0])
			return true;
		if("Month_sales" == $this->chrt_array['tables'][0])
			return true;
